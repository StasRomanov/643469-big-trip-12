  ...
  return `<form class="trip-events__item  event  event--edit event--new" action="#" method="post" data-id="${id}">
    <header class="event__header">
      ...
      <div class="event__field-group  event__field-group--time">
        ...
        <input class="event__input  event__input--time" id="event-start-time-1" type="text" name="event-start-time" value="${moment(startTime).format(`DD/MM/YY HH:mm`)}" data-time="${startTime.toISOString()}">
        &mdash;
        <label class="visually-hidden" for="event-end-time-1">
          To
        </label>
        <input class="event__input  event__input--time" id="event-end-time-1" type="text" name="event-end-time" value="${moment(endTime).format(`DD/MM/YY HH:mm`)}" data-time="${endTime.toISOString()}">
      </div>
      ...
      <div class="event__field-group  event__field-group--price">
        ...
        <input class="event__input  event__input--price" id="event-price-1" type="number" name="event-price" value="" pattern="[0-9]*" placeholder="${price}">
      </div>
